...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2016 at 05:20 AM
...
('avi', 'avin', 'adf', 'asdf', 'asddf@adf.com'),
('ftm', '0ca5aaa5f0c9217e6f45fe1d109c24fa', 'arlington', '85465875', 'test@gmail.com'),
...
('pk', 'pk', 'pk', 'pk', 'pk@asdf.com'),
('prasoon', 'asdf', 'adf', 'adsf', 'adf@adf.com'),
...
('testuser10', '5f4dcc3b5aa765d61d8327deb882cf99', 'arlington', '565455', 'test@gmail.com'),
...
--
ALTER TABLE `shoppingbasket`
  MODIFY `basketId` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
--
